...
mortal_kombat = Game.new(name: "Mortal Kombat 11", description: "The newest installment of the critically acclaimed franchise gives players a deeply personalized experience with the brand-new Custom Character Variation System. Players can choose which Skins, Special Abilities, Intro and Victory Cinemas, Gear, Taunts, andBrutalities they wish to use to suit their style. One of the new characters making a debut is Geras, a servant of Kronika with a powerful time-manipulation ability. Returning fan-favorites include Raiden, Skarlet, Baraka, Scorpion, Sub-Zero, Sonya Blade, and more.Mortal Kombat 11 features multiple modes and challenges to keep you busy, plus a cinematic story that continues the Mortal Kombat legacy.", category: "Adventure", price:17.00, user: user1)
mortal_kombat.save!(validate: false)
